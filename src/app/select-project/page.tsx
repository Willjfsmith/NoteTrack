      ...
      {projects.length === 0 ? (
        <div className="mt-6 rounded-4 border border-line bg-surface p-6 text-ink-2">
          ...
          <p className="mt-2 text-[13px]">
            Ask an owner to add you, or seed a sample project by running{" "}
            <code className="rounded bg-bg-2 px-1 font-mono text-[12px]">supabase db reset</code>{" "}
            on a local Supabase instance and adding yourself as an owner.
          </p>
        </div>
      ) : (
